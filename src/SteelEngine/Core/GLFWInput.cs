...
namespace SteelEngine
{
    public static class GLFWInput
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool WasMouseDown(OpenTK.Windowing.GraphicsLibraryFramework.MouseButton button) => mouse.WasButtonDown(button);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool OnMouseUp(OpenTK.Windowing.GraphicsLibraryFramework.MouseButton button) => mouse.IsButtonReleased(button);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool OnMouseClick(OpenTK.Windowing.GraphicsLibraryFramework.MouseButton button) => mouse.IsButtonDown(button);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool OnMouseHold(OpenTK.Windowing.GraphicsLibraryFramework.MouseButton button) => mouse.IsButtonPressed(button);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool OnDoubleClick(OpenTK.Windowing.GraphicsLibraryFramework.MouseButton button)
        {
