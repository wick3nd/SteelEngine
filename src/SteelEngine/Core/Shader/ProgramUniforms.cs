    ...
    public partial class Shader
    {
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetProgramInt(Shader shader, string name, int value)
        {
            ...
            GL.ProgramUniform1i(handle, shader.GetUniformLoc(name), value);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniform1ui(handle, shader.GetUniformLoc(name), value);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniform1f(handle, shader.GetUniformLoc(name), value);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniform1d(handle, shader.GetUniformLoc(name), value);
        }
       ...
       // Uniform 2 values
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniform2i(handle, shader.GetUniformLoc(name), 1, ref value);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniform2f(handle, shader.GetUniformLoc(name), 1, ref value);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniform2d(handle, shader.GetUniformLoc(name), 1, ref value);
        }
       ...
       // Uniform 3 values
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniform3i(handle, shader.GetUniformLoc(name), 1, ref value);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniform3f(handle, shader.GetUniformLoc(name), 1, ref value);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniform3d(handle, shader.GetUniformLoc(name), 1, ref value);
        }
       ...
       // Uniform 4 values
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniform4i(handle, shader.GetUniformLoc(name), 1, ref value);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniform4f(handle, shader.GetUniformLoc(name), 1, ref value);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniform4d(handle, shader.GetUniformLoc(name), 1, ref value);
        }
       ...
       // Matrix2 values
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix2f(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix2d(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix2x3f(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix2x3d(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix2x4f(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix2x4d(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
       ...
       // Matrix3 values
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix3f(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix3d(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix3x2f(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix3x2d(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix3x4f(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix3x4d(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
       ...
       // Matrix4 values
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix4f(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix4d(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix4x2f(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix4x2d(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix4x3f(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
        ...
        {
            int handle = shader.GetHandle();
            GL.ProgramUniformMatrix4x3d(handle, shader.GetUniformLoc(name), 1, transpose, ref matrix);
        }
       ...
       // Uniform 1 arrays
        ...
        public static unsafe void SetProgramIntArray(Shader shader, string name, int[] value)
        {
            ...
            fixed (int* ptr = value)
            GL.ProgramUniform1iv(handle, shader.GetUniformLoc(name), value.Length, ptr);
        }
        ...
        public static unsafe void SetProgramUIntArray(Shader shader, string name, uint[] value)
        {
            ...
            GL.ProgramUniform1uiv(handle, shader.GetUniformLoc(name), value.Length, ptr);
        }
        ...
        public static unsafe void SetProgramFloatArray(Shader shader, string name, float[] value)
        {
            ...
            GL.ProgramUniform1fv(handle, shader.GetUniformLoc(name), value.Length, ptr);
        }
        ...
        public static unsafe void SetProgramDoubleArray(Shader shader, string name, double[] value)
        {
            ...
            GL.ProgramUniform1dv(handle, shader.GetUniformLoc(name), value.Length, ptr);
        }
       ...
       // Uniform 2 arrays
        ...
        public static unsafe void SetProgramVec2Array(Shader shader, string name, Vector2i[] value)
        {
            ...
            GL.ProgramUniform2iv(handle, shader.GetUniformLoc(name), value.Length, (int*)ptr);
        }
        ...
        public static unsafe void SetProgramVec2Array(Shader shader, string name, Vector2[] value)
        {
            ...
            GL.ProgramUniform2fv(handle, shader.GetUniformLoc(name), value.Length, (float*)ptr);
        }
        ...
        public static unsafe void SetProgramVec2Array(Shader shader, string name, Vector2d[] value)
        {
            ...
            GL.ProgramUniform2dv(handle, shader.GetUniformLoc(name), value.Length, (double*)ptr);
        }
       ...
       // Uniform 3 arrays
        ...
        public static unsafe void SetProgramVec3Array(Shader shader, string name, Vector3i[] value)
        {
            ...
            GL.ProgramUniform3iv(handle, shader.GetUniformLoc(name), value.Length, (int*)ptr);
        }
        ...
        public static unsafe void SetProgramVec3Array(Shader shader, string name, Vector3[] value)
        {
            ...
            GL.ProgramUniform3fv(handle, shader.GetUniformLoc(name), value.Length, (float*)ptr);
        }
        ...
        public static unsafe void SetProgramVec3Array(Shader shader, string name, Vector3d[] value)
        {
            ...
            GL.ProgramUniform3dv(handle, shader.GetUniformLoc(name), value.Length, (double*)ptr);
        }
       ...
       // Uniform 4 arrays
        ...
        public static unsafe void SetProgramVec4Array(Shader shader, string name, Vector4i[] value)
        {
            ...
            GL.ProgramUniform4iv(handle, shader.GetUniformLoc(name), value.Length, (int*)ptr);
        }
        ...
        public static unsafe void SetProgramVec4Array(Shader shader, string name, Vector4[] value)
        {
            ...
            GL.ProgramUniform4fv(handle, shader.GetUniformLoc(name), value.Length, (float*)ptr);
        }
        ...
        public static unsafe void SetProgramVec4Array(Shader shader, string name, Vector4d[] value)
        {
            ...
            GL.ProgramUniform4dv(handle, shader.GetUniformLoc(name), value.Length, (double*)ptr);
        }
       ...
       // Metrix2 arrays
        ...
        public static unsafe void SetProgramMatrix2Array(Shader shader, string name, Matrix2[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix2fv(handle, shader.GetUniformLoc(name), 1, transpose, (float*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix2Array(Shader shader, string name, Matrix2d[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix2dv(handle, shader.GetUniformLoc(name), 1, transpose, (double*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix2x3Array(Shader shader, string name, Matrix2x3[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix2x3fv(handle, shader.GetUniformLoc(name), 1, transpose, (float*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix2x3Array(Shader shader, string name, Matrix2x3d[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix2x3dv(handle, shader.GetUniformLoc(name), 1, transpose, (double*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix2x4Array(Shader shader, string name, Matrix2x4[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix2x4fv(handle, shader.GetUniformLoc(name), 1, transpose, (float*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix2x4Array(Shader shader, string name, Matrix2x4d[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix2x4dv(handle, shader.GetUniformLoc(name), 1, transpose, (double*)ptr);
        }
       ...
       // Metrix3 arrays
        ...
        public static unsafe void SetProgramMatrix3Array(Shader shader, string name, Matrix3[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix3fv(handle, shader.GetUniformLoc(name), 1, transpose, (float*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix3Array(Shader shader, string name, Matrix3d[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix3dv(handle, shader.GetUniformLoc(name), 1, transpose, (double*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix3x2Array(Shader shader, string name, Matrix3x2[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix3x2fv(handle, shader.GetUniformLoc(name), 1, transpose, (float*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix3x2Array(Shader shader, string name, Matrix3x2d[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix3x2dv(handle, shader.GetUniformLoc(name), 1, transpose, (double*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix3x4Array(Shader shader, string name, Matrix3x4[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix3x4fv(handle, shader.GetUniformLoc(name), 1, transpose, (float*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix3x4Array(Shader shader, string name, Matrix3x4d[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix3x4dv(handle, shader.GetUniformLoc(name), 1, transpose, (double*)ptr);
        }
       ...
       // Metrix4 arrays
        ...
        public static unsafe void SetProgramMatrix4Array(Shader shader, string name, Matrix4[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix4fv(handle, shader.GetUniformLoc(name), 1, transpose, (float*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix4Array(Shader shader, string name, Matrix4d[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix4dv(handle, shader.GetUniformLoc(name), 1, transpose, (double*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix4x2Array(Shader shader, string name, Matrix4x2[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix4x2fv(handle, shader.GetUniformLoc(name), 1, transpose, (float*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix4x2Array(Shader shader, string name, Matrix4x2d[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix4x2dv(handle, shader.GetUniformLoc(name), 1, transpose, (double*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix4x3Array(Shader shader, string name, Matrix4x3[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix4x3fv(handle, shader.GetUniformLoc(name), 1, transpose, (float*)ptr);
        }
        ...
        public static unsafe void SetProgramMatrix4x3Array(Shader shader, string name, Matrix4x3d[] value, bool transpose = false)
        {
            ...
            GL.ProgramUniformMatrix4x3dv(handle, shader.GetUniformLoc(name), 1, transpose, (double*)ptr);
        }
    }
}