...
#pragma warning disable IDE0060
    ...
    {
        internal static int GLVersion => (GL.GetInteger(GetPName.MajorVersion) << 16) | GL.GetInteger(GetPName.MinorVersion);
        internal static int MaxColorTextureSamples => GL.GetInteger(GetPName.MaxColorTextureSamples);
        internal static int MaxDepthTextureSamples => GL.GetInteger(GetPName.MaxDepthTextureSamples);
        internal static int MaxFramebufferSamples => GL.GetInteger(GetPName.MaxFramebufferSamples);
        internal static int MaxIntegerSamples => GL.GetInteger(GetPName.MaxIntegerSamples);
        ...
        internal static void GetExtensions()
        {
            for (uint i = 0; i < GL.GetInteger(GetPName.NumExtensions); i++)
            {
                ...
                extensions.Add(ext!);
#if DEBUG
                SEDebug.Log(SEDebugState.Debug, ext);
#endif
            }
        }
