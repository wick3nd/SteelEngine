...
namespace SteelEngine.Utils
{
    public static class SEMath
    {
        ...
        public static Quaternion CreateQuatRotation(float xRot = 0, float yRot = 0, float zRot = 0, AxisOrder rotAxes = AxisOrder.YXZ)
        {
        ...
        /// <param name="rotAxes">Affects the order of axis multiplication.</param>
        /// <returns>A <see cref="Quaternion"/> rotation represented as a <see cref="Matrix4"/>.</returns>
        public static Quaternion CreateQuatRotation(Vector3 rotation, AxisOrder rotAxes = AxisOrder.YXZ)
        {
